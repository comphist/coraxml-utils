...
replacements = [
    ...
    [
        ...
        "\uF158",
        "et",
    ],  # geaendert von 204A auf wunsch des anselm projekts
    ...
    [
        ...
        "\u02E2",
        "r",
    ],  # ersetze ' durch r, falls ein Vokal voransteht
    [
        r"(?<!\\)'(?=[äöüaeiouy])",
        "\u02E2",
        "r",
    ...
    def __eq__(self, obj):
        ...
        if not isinstance(obj, self.__class__):
            ...
            return (
                ...
                and self.dipl_utf == obj.dipl_utf
                and self.anno_utf == obj.anno_utf
                and self.anno_simple == obj.anno_simple
                and self.anno_bound == obj.anno_bound
                and self.dipl_bound == obj.dipl_bound
                and self.line_break_after == obj.line_break_after
            )
